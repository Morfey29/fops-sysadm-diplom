#  Курсовая работа на профессии "DevOps-инженер с нуля" Дойков А.М.
...
Internet
│
├── ALB (81.26.178.199) → web-1 (10.0.1.8), web-2 (10.0.2.5)
│
├── Bastion (111.88.250.138) → SSH доступ к приватным ВМ
│
├── Zabbix (130.193.39.254) → мониторинг всех ВМ
│
└── Kibana (93.77.190.112) → визуализация логов из Elasticsearch


### Выбор технологий
- **Zabbix вместо Prometheus**: Проще настройка, встроенный UI, не требует дополнительных компонентов
- **Bastion как NAT**: Экономия ресурсов (нет платного NAT Gateway)
